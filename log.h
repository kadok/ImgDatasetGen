...
/**
 * @class LogImgDataset
 * @brief The LogImgDataset class - The class LogImgDataset represents the log of the system using the library log4cpp.
 */
class LogImgDataset
{
    public:
    ...
    private:
        log4cpp::Appender *app; /*!< Appender declaration*/
        LogImgDataset();
